defmodule RogerUi.RogerApi do
  ...
  defdelegate purge_queue(partition_name, queue_name),
    to: Roger.Queue, as: :purge
  defdelegate queue_pause(partition_name, queue_name),
    to: Roger.Partition.Global
  defdelegate queue_resume(partition_name, queue_name),
    to: Roger.Partition.Global
  ...
  defdelegate queued_jobs(partition_name, queue_name, count \\ 100),
    to: Roger.Info
end
